"undefined" == typeof jwplayer && (jwplayer = function (e) {
    ...
    c.repo = function () {
        ...
        L(a)
        return "app/Share/resource/jwplayer/"
    };
    ...
    function (e) {
        ...
        e.embed = l.extend(function (f) {
            ...
            var c = l.repo(), m = l.extend({}, e.defaults), b = l.extend({}, m, f.config), p = f.config, h = b.plugins, q = b.analytics, n = c + "jwp.js", k = c + "sharing.js", j = c + "related.js", u = c + "gapro.js", m = e.key ? e.key : m.key, t = (new e.utils.key(m)).edition(), r, h = h ? h : {};
