 ...
 */
Ext.define('RZSJ.controller.WSUserController', {
    ...
    onSearch: function (obj) {
        var tempForm = Ext.getCmp('rzsj_wu_czlx_form').getForm();
        if (tempForm.isValid()) {
            var pData = tempForm.getValues();

            var record = Ext.getCmp('rzsj_wu_czlx_org').org_val.raw;
            ...
            var raval = Ext.getCmp('rzsj_wu_czlx_org').rawValue;
            ...
            L(pData)
            var store = Ext.getCmp('rzsj_wu_search_grid').getStore();
