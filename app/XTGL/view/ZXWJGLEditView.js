Ext.define('XTGL.view.ZXWJGLEditView', {
    ...
    layout: "fit",
    cls: 'xtgl_zxwjgl_editwindow',
    requires: ['Share.view.TreeCombo'],
    items: [
        {
            xtype: 'form',
            id: 'xtgl_zxwjgl_edit_form',
            margin: "20 20 10 20",
            layout: "border",
            defaults: {
                border: false,
